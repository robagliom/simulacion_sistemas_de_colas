...
#Simulación sistema de colas, ver bosquejo: imagen "caso_3.png"
...
pol_atencion_cola_A = 'RANDOM' #Hacer función que ordene la cola según este campo
...
def partida_B():
    ...
    if num_clientes_cola_A > 0:
        ...
        pos = random.randrange(0, len(cola_A)) #elijo al azar el cliente que sale de la cola
        demora = reloj - cola_A[pos] #calculo la demora del cliente que elegi al azar por ser random la politica de atencion
        ...
        #RANDOM saco de la cola al cliente elegido al azar
        cola_A.pop(pos)
