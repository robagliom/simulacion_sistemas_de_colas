...
def arribo_B():
    global reloj,prioridad,clientes_prioridad,tasa_arribo_prioridad,prox_arribo_B,tiempo_medio_e_arribos_cola_A,estado_servidores_B,tiempo_medio_servicio_B,prox_partidas_B,num_completo_demora_A,area_estado_servidores_B,num_clientes_cola_A,cola_A,area_num_clientes_cola_A,tiempo_ultimo_evento
    ...
    #Generamos prioridad proximo arribo
    prioridad = np.random.poisson(tasa_arribo_prioridad)
    ...
    if len(servidores_libres)>0:
        ...
        if prioridad_actual == 1:
            ...
            cola_A.insert(0,prox_arribo_B) #guardamos el tiempo de arribo del cliente en la posición 0
...
def informes():
    global clientes_prioridad,num_clientes_cola_A,num_clientes_cola_C1,num_clientes_cola_C2,num_completo_demora_A,num_completo_demora_C,demora_acum_A,demora_acum_C,tiempo_ultimo_evento,area_num_clientes_cola_A,area_num_clientes_cola_C1,area_num_clientes_cola_C2,area_estado_servidores_B,area_estado_servidores_D
    print('Informes')
